...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      '--secondary':       '#ffd166',
      '--secondary-light': 'rgba(255, 209, 102, 0.15)',
      '--accent':          '#4cc9f0',
      '--accent-hover':    '#37b7de',
      '--accent-light':    'rgba(76, 201, 240, 0.15)',
      '--mint':            '#06d6a0',
      '--mint-light':      'rgba(6, 214, 160, 0.15)',
      '--bg-app':          '#141113',
      '--card-bg':         '#1d181b',
      '--text-dark':       '#fdf2f5',
      '--text-light':      '#9e8f95',
      '--border-color':    '#2d2529',
      '--danger':          '#ef476f',
      '--shadow-hover':    '0 20px 48px rgba(255, 107, 139, 0.25)',
      '--scrollbar-thumb': '#2d2529',
      '--scrollbar-hover': '#40353a',
    },
  },
  {
    id: 'sky',
